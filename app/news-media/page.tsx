...
export default function NewsMediaPage() {
  return (
    <main className="relative bg-white min-h-screen">
      <PageHeader eyebrow="Press & Updates" title="News & Media" />
        ...
        <Container className="relative z-10 max-w-4xl">
          <ContentSection delay={0.1}>
            <p className="text-xl leading-relaxed text-[#0F172A] font-medium text-center mb-8">
              Stay up to date with the latest announcements, press releases, and media coverage from Conlog.
            </p>
            <div className="p-12 border border-dashed border-cyan-500/30 rounded-[2rem] bg-gradient-to-b from-slate-50 to-[#E6F0F7] flex flex-col items-center justify-center min-h-[300px]">
              ...
              <p className="text-[#004B87] text-lg font-medium text-center">Recent news articles and press assets will populate here.</p>
